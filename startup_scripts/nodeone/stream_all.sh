...
### ------------ WAIT TILL MASTER IS UP AND RUNNING
### ------------ CONFIG MASTER_IP
MASTER_IP="10.0.0.3"
until ping -c 1 -W 1 "$MASTER_IP" &> /dev/null
do
  printf "."
  sleep 1
done
...
# Variables
HOST_IP="10.0.0.24"
BITRATE=20000000         # Default bitrate (Unsigned Integer. Range: 0 - 4294967295 Default: 4000000 )
