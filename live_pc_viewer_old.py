...
def main():
    ...
    try:
        while True:
            ...
            conf_flat = conf_flat[radius_mask]
            ...
            # Confidence-based filtering: keep only high-confidence points
            conf_threshold = 0.3  # expp1 activation outputs >= 1.0; typical good points > 1.5
